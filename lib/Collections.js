...
if(Meteor.isClient){
    ...
    if(get(Meteor, 'settings.private.disableDefaultDirectoryPublications') !== true){
        ...
        Tracker.autorun(function(){
            ...
            Meteor.subscribe('Practitioners', Session.get("selectedPatientId"), Session.get('currentUser'));
...
if(Meteor.isServer){
  ...
  if(get(Meteor, 'settings.private.disableDefaultDirectoryPublications') !== true){
    ...
    Meteor.publish('Practitioners', function(selectedPatientId, currentUser){
